...
object FileUtils {
    ...
    fun queueImageDownload(context: Context, downloadPath: String) {
        val file = File(context.externalMediaDirs.first(), downloadPath)

        val request = DownloadManager.Request(Uri.parse("$BASE_URL/files/$downloadPath"))
